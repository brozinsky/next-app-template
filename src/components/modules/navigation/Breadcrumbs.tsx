                ...
                {crumbsArray.length !== index + 1 ? (
                  ...
                  <li aria-current="page">
                    <div className="flex items-center">
                      <span className="ml-1 text-sm font-medium text-gray-500 capitalize md:ml-2 dark:text-gray-400">{crumb}</span>
                    </div>
                  </li>
                )}
              </React.Fragment>
