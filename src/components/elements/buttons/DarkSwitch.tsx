...
const DarkSwitch = () => {
  ...
  return (
    <div className="theme-switch">
      ...
      <label htmlFor="toggle" className="cursor-pointer theme-switch__label">
        <span className={`theme-switch__icon theme-switch__icon--light`}>
          <svg className="w-full h-full" width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <span className={`theme-switch__icon theme-switch__icon--dark`}>
          <svg className="w-full h-full" width="169" height="169" viewBox="0 0 169 169" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
